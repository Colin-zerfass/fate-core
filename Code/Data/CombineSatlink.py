...
folderpath = r"Palmyra_Data_CSV\Satlink"
...
csv = r"Palmyra_Data_CSV\Satlink\Other Data\2021-202312 Palmyra Export.csv"
data2 = pd.read_csv(csv, sep= ",", index_col=None,low_memory=False)
data = pd.concat([data,data2], ignore_index=True)

csv = r"Palmyra_Data_CSV\Satlink\Other Data\210925 DR+ES Dump.csv"
data2 = pd.read_csv(csv, sep= ";", index_col=None,low_memory=False)
