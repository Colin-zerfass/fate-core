...
if __name__ == '__main__':
    ...
    dFADs = 'SAT_MI_FAD_cleanedspeeds_2026-01-01_mapped_all_depths.parquet'
    ...
    GLORYs  = xr.open_dataset(r'Data\cmems_2021_2026.nc')
    GLORYs_mean = (GLORYs.sel(time = slice('2021-01-01', '2025-12-31'), depth = 13.4671)
                    .mean(dim= ['time', 'latitude', 'longitude']))
    ERA5  = xr.open_dataset(r'Data\ERA5_10m_winds_2021_2026.nc')
